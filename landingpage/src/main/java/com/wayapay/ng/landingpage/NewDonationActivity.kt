...
import com.wayapay.ng.landingpage.databinding.ActivityNewDonationBinding
...
class NewDonationActivity : AppCompatActivity() {

    private lateinit var binding: ActivityNewDonationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_new_donation)
        ...
        if(bundle != null){
            val donation = bundle.getSerializable(IntentBundles.DONATION_KEY) as WayaDonation
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == RequestCodes.CROP_IMAGE && resultCode == Activity.RESULT_OK){
            ...
            donation.imageUrl = uri.toString()
            donation.filePath = filePath ?: ""
            viewModel.setDonation(donation)
