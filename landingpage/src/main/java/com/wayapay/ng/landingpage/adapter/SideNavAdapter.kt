...
import com.wayapay.ng.landingpage.databinding.ListSideNavItemsBinding
import com.wayapay.ng.landingpage.utils.NavItem
...
class SideNavAdapter(private val onClickListener: OnClickListener):RecyclerView.Adapter<SideNavAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val binding = ListSideNavItemsBinding.inflate(layoutInflater, parent, false)
    ...
    inner class MyViewHolder(private val binding: ListSideNavItemsBinding):RecyclerView.ViewHolder(binding.root){
